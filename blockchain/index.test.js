...
describe('Blockchain', () => {
   ...
   describe('isValidChain()', () => {
      ...
      describe('when the chain starts with the genesis block and has multiple blocks', () => {
         ...
         beforeEach(() => {
            ...
            blockchain.addBlock({ data: 'Bohemian Rhapsody' });
         });
   ...
   describe('replaceChain()', () => {
      ...
      describe('when the new chain is longer', () => {
         beforeEach(() => {
            ...
            newChain.addBlock({ data: 'Bohemian Rhapsody' });
         });
   ...
   describe('validTransactionData()', () => {
      ...
      beforeEach(() => {
         wallet = new Wallet();
         transaction = wallet.createTransaction({ recipiend: 'foo-address', amount: 65 });
